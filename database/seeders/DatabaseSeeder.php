...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Category::factory()->createMany([
            ...
            ['name' => 'Summer', 'emoji' => '☀️', 'parent_id' => 1, 'category_type_id' => null],
            ['name' => 'Winter', 'emoji' => '❄️', 'parent_id' => 1, 'category_type_id' => null],
            ...
            ['name' => 'Games', 'emoji' => '🎮', 'parent_id' => 4, 'category_type_id' => null],
            ['name' => 'Books', 'emoji' => '📘', 'parent_id' => 4, 'category_type_id' => null],
            ['name' => 'Food', 'emoji' => null, 'parent_id' => null],
            ['name' => 'Restaurants ZH', 'emoji' => '🍽️', 'parent_id' => 9, 'category_type_id' => null],
            ['name' => 'Restaurants Elsewhere', 'emoji' => '🍜', 'parent_id' => 9, 'category_type_id' => null],
            ['name' => 'Recipes', 'emoji' => '📄', 'parent_id' => 9, 'category_type_id' => null],
            ['name' => 'Cooking / Baking Ideas', 'emoji' => '🥐', 'parent_id' => 9, 'category_type_id' => null],
            ['name' => 'Projects', 'emoji' => null, 'parent_id' => null],
            ['name' => 'General', 'emoji' => '🪚', 'parent_id' => 14, 'category_type_id' => null],
            ['name' => 'Programming', 'emoji' => '💻', 'parent_id' => 14, 'category_type_id' => null],
            ['name' => 'Other', 'emoji' => null, 'parent_id' => null],
            ['name' => 'Gift-Ideas', 'emoji' => '🎁', 'parent_id' => 17, 'category_type_id' => null],
            ['name' => 'Miscellaneous', 'emoji' => '✨', 'parent_id' => 17, 'category_type_id' => null],
